...
func (s *ComparerTestSuite) TestNilIsSmallest() {
	otherStuff := [...]any{"string", "", -1, 0, uint(12), false,
		time.UnixMilli(12345), Document{}, Document{"hello": "world"},
		[]any{}, []any{"quite", 5},
	}
...
func (s *ComparerTestSuite) TestNumberIsSecondSmallest() {
	...
	otherStuff := [...]any{"string", "", false, time.UnixMilli(12345),
		Document{}, Document{"hello": "world"}, []any{},
		[]any{"quite", 5},
	}
...
func (s *ComparerTestSuite) TestStringIsThirdSmallest() {
	...
	otherStuff := [...]any{false, time.UnixMilli(12345), Document{},
		Document{"hello": "world"}, []any{}, []any{"quite", 5},
	}
...
func (s *ComparerTestSuite) TestBoolIsFourthSmallest() {
	...
	otherStuff := [...]any{time.UnixMilli(12345), Document{},
		Document{"hello": "world"}, []any{}, []any{"quite", 5},
	}
...
func (s *ComparerTestSuite) TestDateIsFifthSmallest() {
	...
	otherStuff := [...]any{Document{}, Document{"hello": "world"},
		[]any{}, []any{"quite", 5},
	}
...
func (s *ComparerTestSuite) TestDocumentIsSeventhSmallest() {
	testCases := []struct {
		...
		{arg1: Document{"a": 42}, arg2: Document{"a": 312}, res: -1},
		{arg1: Document{"a": "42"}, arg2: Document{"a": "312"}, res: 1},
		{arg1: Document{"a": 42, "b": 312}, arg2: Document{"b": 312, "a": 42}, res: 0},
		{arg1: Document{"a": 42, "b": 312, "c": 54}, arg2: Document{"b": 313, "a": 42}, res: -1},
		{arg1: Document{"a": 42, "b": 312, "c": 54}, arg2: struct{}{}, res: -1},
		{arg1: struct{}{}, arg2: Document{"b": 313, "a": 42}, res: 1},
	}
...
func (s *ComparerTestSuite) TestErrorOnUnknownPair() {
	testCases := []struct {
		...
		{arg1: Document{"nested": []string{"invalid"}}, arg2: Document{"invalid": []int{}}},
