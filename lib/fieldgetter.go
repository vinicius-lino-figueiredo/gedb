...
// FieldGetter implements [gedb.FieldGetter].
type FieldGetter struct{}

// NewFieldGetter returns a new instance of [gedb.FieldGetter].
func NewFieldGetter() gedb.FieldGetter {
	return &FieldGetter{}
}

// GetField implements [gedb.FieldGetter].
...
// SplitFields implements [gedb.FieldGetter].
