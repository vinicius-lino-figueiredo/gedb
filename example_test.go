...
// Aliasing a map is a easy way to make queries more readable.
...
func ExampleNewDB() {
	...
	// imediatelly stop waiting if cancellation occurs before starting the
	// action.
...
func ExampleGEDB_Insert() {
	...
	// Open cursors should always be closed afte use.
	defer cur.Close()
