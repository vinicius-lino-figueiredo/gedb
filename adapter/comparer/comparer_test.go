...
var undefined = &getSetterMock{}

type getSetterMock struct {
	get   func() (any, bool)
	set   func(any)
	unset func()
}
...
func (g *getSetterMock) Get() (value any, defined bool) {
	if g.get != nil {
		return g.get()
	}
	return nil, false
...
func (g *getSetterMock) Set(value any) {
	if g.set != nil {
		g.set(value)
	}
}
...
func (s *ComparerTestSuite) TestGetSetterDefinedValues() {
	a := &getSetterMock{get: func() (any, bool) {
		return data.M{"a": 1, "b": 2}, true
	}}
	b := &getSetterMock{get: func() (any, bool) {
		return data.M{"a": 1, "b": 2, "c": 3}, true
	}}
